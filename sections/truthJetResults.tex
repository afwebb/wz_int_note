...
Process & $\mu$ & $\sigma$ \\
\hline
WZ + $b$ - 1-jet & $1.00^{+0.47}_{-0.43}(stat)^{+0.32}_{-0.27}(sys)$ & $1.74^{+0.82}_{-0.75}(stat)^{+0.53}_{-0.48}(sys)$ fb \\
...
WZ + $c$ - 2-jet & $1.00^{+0.25}_{-0.24}(stat)^{+0.32}_{-0.27}(sys)$ & $12.7^{+3.3}_{-3.2}(stat)^{+3.9}_{-3.4}(sys) \pm 3.2 (stat) \pm 2.7 (sys)$ fb \\
\hline
\end{tabular}
...
\begin{table}[H]
      ...
      \begin{tabular}{l|cc}
        ...
        \hline
        Jet Energy Scale & 0.14 & -0.15 \\
        WZ + light, 1-jet cross-section & 0.12 & -0.14 \\
        WZ + $c$, 1-jet cross-section & -0.09 & 0.11 \\
        tZ Modelling (shower tune) & -0.07 & 0.08 \\
        Other Diboson + b cross-section & -0.07 & 0.07 \\
        tZ cross-section & -0.06 & 0.08 \\
        Jet Energy Resolution & -0.07 & 0.07 \\
