...
\begin{figure}[H]
    \centering
    \subfigure[]{\includegraphics[width=.32\linewidth]{signalModel/truthJets/plots/migrations_bjets.pdf}}%                
    \subfigure[]{\includegraphics[width=.32\linewidth]{signalModel/truthJets/plots/migrations_charm.pdf}}%    
    \subfigure[]{\includegraphics[width=.32\linewidth]{signalModel/truthJets/plots/migrations_light.pdf}}\\
