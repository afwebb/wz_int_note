...
Theoritical uncertainties applied to MC predictions, including cross section, PDF, and scale uncertainties are taken from theory calculations, with the exception of non-prompt and diboson backgrounds. The cross-section uncertainty on tZ is taken from \ref{tZ_paper}. Derivation of the non-prompt background uncertainties, Z+jets and $t\bar{t}$, are explained in detail in section \ref{sec:fakes}. 

The other VV + heavy flavor processes (namely VV+b and VV+charm, which primarily comprise of ZZ events) are also poorly understood, because these processes involve much of the same physics as WZ + heavy flavor, and have also not been measured. Therefore, a conservative 50\% uncertainty is applied to those samples. 
...
\begin{figure}[H]
    \centering
    \subfigure[]{\includegraphics[width=.29\linewidth]{signalModel/plots/bjets1j.pdf}}%                  
    \subfigure[]{\includegraphics[width=.29\linewidth]{signalModel/plots/charm1j.pdf}}%
    \subfigure[]{\includegraphics[width=.29\linewidth]{signalModel/plots/light1j.pdf}}\\
...
\begin{figure}[H]
    \centering
    \subfigure[]{\includegraphics[width=.29\linewidth]{signalModel/plots/bjets2j.pdf}}%                                    
    \subfigure[]{\includegraphics[width=.29\linewidth]{signalModel/plots/charm2j.pdf}}%                                     
    \subfigure[]{\includegraphics[width=.29\linewidth]{signalModel/plots/light2j.pdf}}\\
