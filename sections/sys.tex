...
\begin{figure}[H]
    \centering
    \subfigure[]{\includegraphics[width=.45\linewidth]{signalModel/plotsNotZ/bjets1j.pdf}}%                  
    \subfigure[]{\includegraphics[width=.45\linewidth]{signalModel/plotsNotZ/charm1j.pdf}}\\
    \subfigure[]{\includegraphics[width=.45\linewidth]{signalModel/plotsNotZ/light1j.pdf}}%
...
\begin{figure}[H]
    \centering
    \subfigure[]{\includegraphics[width=.45\linewidth]{signalModel/plotsNotZ/bjets2j.pdf}}%                     
    \subfigure[]{\includegraphics[width=.45\linewidth]{signalModel/plotsNotZ/charm2j.pdf}}\\                           
    \subfigure[]{\includegraphics[width=.45\linewidth]{signalModel/plotsNotZ/light2j.pdf}}%
...
\begin{figure}[H]
    \centering
    \subfigure[]{\includegraphics[width=.45\linewidth]{signalModel/truthJets/plots/migrations_bjets.pdf}}%                
    \subfigure[]{\includegraphics[width=.45\linewidth]{signalModel/truthJets/plots/migrations_charm.pdf}}\\    
    \subfigure[]{\includegraphics[width=.45\linewidth]{signalModel/truthJets/plots/migrations_light.pdf}}%
