...
\begin{figure}%[H]
    ...
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_inclusive/Plots/lead_jetPt.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_inclusive/Plots/lep_Pt_0.png}}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_inclusive/Plots/lep_Pt_1.png}}%      
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_inclusive/Plots/lep_Pt_2.png}}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_inclusive/Plots/MET.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_inclusive/Plots/Mll01.png}}\\
    \label{kin:inclusive}
\end{figure}

\begin{figure}%[H]
    \textbf{WZ Fit Region - 1j $<$ 85\% WP}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_not_85/Plots/lead_jetPt.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_not_85/Plots/lep_Pt_0.png}}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_not_85/Plots/lep_Pt_1.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_not_85/Plots/lep_Pt_2.png}}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_not_85/Plots/MET.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_not_85/Plots/Mll01.png}}\\
    \label{kin:WP_1j_not85}
\end{figure}

\begin{figure}%[H]
    \textbf{WZ Fit Region - 1j 77-85\% WP}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_1j_77_85/Plots/lead_jetPt.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_1j_77_85/Plots/lep_Pt_0.png}}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_1j_77_85/Plots/lep_Pt_1.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_1j_77_85/Plots/lep_Pt_2.png}}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_1j_77_85/Plots/MET.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_1j_77_85/Plots/Mll01.png}}\\
    \label{kin:WP_1j_77_85}
\end{figure}

\begin{figure}%[H]
    \textbf{WZ Fit Region - 1j 70-77\% WP}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_1j_70_77/Plots/lead_jetPt.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_1j_70_77/Plots/lep_Pt_0.png}}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_1j_70_77/Plots/lep_Pt_1.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_1j_70_77/Plots/lep_Pt_2.png}}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_1j_70_77/Plots/MET.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_1j_70_77/Plots/Mll01.png}}\\
    \label{kin:WP_1j_70_77}   
\end{figure}

\begin{figure}%[H]
    \textbf{WZ Fit Region - 1j 60-70\% WP}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_1j_60_70/Plots/lead_jetPt.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_1j_60_70/Plots/lep_Pt_0.png}}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_1j_60_70/Plots/lep_Pt_1.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_1j_60_70/Plots/lep_Pt_2.png}}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_1j_60_70/Plots/MET.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_1j_60_70/Plots/Mll01.png}}\\
    \label{kin:WP_1j_60_70}
\end{figure}

\begin{figure}%[H]
    \textbf{WZ Fit Region - 1j 60\% WP}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_1j_60/Plots/lead_jetPt.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_1j_60/Plots/lep_Pt_0.png}}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_1j_60/Plots/lep_Pt_1.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_1j_60/Plots/lep_Pt_2.png}}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_1j_60/Plots/MET.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_1j_60/Plots/Mll01.png}}\\
    \label{kin:WP_1j_60}    
\end{figure}

\begin{figure}%[H]
    \textbf{WZ Fit Region - tZ-CR}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_tZ_CR/Plots/lead_jetPt.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_tZ_CR/Plots/lep_Pt_0.png}}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_tZ_CR/Plots/lep_Pt_1.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_tZ_CR/Plots/lep_Pt_2.png}}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_tZ_CR/Plots/MET.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_tZ_CR/Plots/Mll01.png}}\\
    \label{kin:tZ_CR_1j}
\end{figure}

\begin{figure}%[H]
    \textbf{WZ Fit Region - 2j $<$ 85\% WP}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_not_85_2j/Plots/lead_jetPt.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_not_85_2j/Plots/lep_Pt_0.png}}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_not_85_2j/Plots/lep_Pt_1.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_not_85_2j/Plots/lep_Pt_2.png}}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_not_85_2j/Plots/MET.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_not_85_2j/Plots/Mll01.png}}\\
    \label{kin:WP_2j_not85}
\end{figure}

\begin{figure}%[H]
    \textbf{WZ Fit Region - 2j 77-85\% WP}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_2j_77_85/Plots/lead_jetPt.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_2j_77_85/Plots/lep_Pt_0.png}}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_2j_77_85/Plots/lep_Pt_1.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_2j_77_85/Plots/lep_Pt_2.png}}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_2j_77_85/Plots/MET.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_2j_77_85/Plots/Mll01.png}}\\
    \label{kin:WP_2j_77_85}
\end{figure}

\begin{figure}%[H]
    \textbf{WZ Fit Region - 2j 70-77\% WP}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_2j_70_77/Plots/lead_jetPt.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_2j_70_77/Plots/lep_Pt_0.png}}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_2j_70_77/Plots/lep_Pt_1.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_2j_70_77/Plots/lep_Pt_2.png}}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_2j_70_77/Plots/MET.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_2j_70_77/Plots/Mll01.png}}\\
    \label{kin:WP_2j_70_77}
\end{figure}

\begin{figure}%[H]
    \textbf{WZ Fit Region - 2j 60-70\% WP}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_2j_60_70/Plots/lead_jetPt.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_2j_60_70/Plots/lep_Pt_0.png}}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_2j_60_70/Plots/lep_Pt_1.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_2j_60_70/Plots/lep_Pt_2.png}}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_2j_60_70/Plots/MET.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_2j_60_70/Plots/Mll01.png}}\\
    \label{kin:WP_2j_60_70}
\end{figure}

\begin{figure}%[H]
    \textbf{WZ Fit Region - 2j 60\% WP}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_2j_60/Plots/lead_jetPt.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_2j_60/Plots/lep_Pt_0.png}}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_2j_60/Plots/lep_Pt_1.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_2j_60/Plots/lep_Pt_2.png}}\\
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_2j_60/Plots/MET.png}}%
    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_2j_60/Plots/Mll01.png}}\\
    \label{kin:WP_2j_60}
\end{figure}

\begin{figure}[H]
    \textbf{WZ Fit Region - tZ-CR-2j}\\
%    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_tZ_CR_2j/Plots/lead_jetPt.png}}%
%    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_tZ_CR_2j/Plots/lep_Pt_0.png}}%
%    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_tZ_CR_2j/Plots/lep_Pt_1.png}}\\
%    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_tZ_CR_2j/Plots/lep_Pt_2.png}}%
%    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_tZ_CR_2j/Plots/MET.png}}%
%    \subfigure[]{\includegraphics[width=.48\linewidth]{regions/plots_tZ_CR_2j/Plots/Mll01.png}}\\
    \label{kin:tZ_CR_2j}
\end{figure}
