...
\begin{figure}[H]
    ...
    \subfigure[]{\includegraphics[width=0.29\textwidth]{zjets/MET.png}}%
    ...
    \subfigure[]{\includegraphics[width=0.29\textwidth]{zjets/nJets_OR_DL1r_70.png}}\\
    \caption{Comparisons between the data and MC distributions in the $Z$+jets validation region for (a) the $p_T$ of the leading jet, (b) the missing transverse energy, (c) the $p_T$ of lepton 0, (d) $p_T$ of lepton 1, (e) $p_T$ of lepton 2, (f) the invariant mass of leptons 0 and 1, (g) the invariant mass of leptons 0 and 2, (h) the number of jets, (i) the number of b-tagged jets.}
