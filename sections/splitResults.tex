...
\textbf{The results of the fit are currently blinded.} The post-fit yields in each region are summarized in figure \ref{fig:fit_regions_1j}.
...
%        \input{figures/1j/Yields_postFit.tex}
%        }
%\end{center} 
%\end{table} 
%\end{landscape}
...
\textbf{The results of the fit are currently blinded.} The post-fit yields in each region are summarized in figure \ref{fig:fit_regions_2j}.
...
%\caption{\label{tbl:yields} Background, signal and observed yields in the twelve analysis categories in 36.1 %\ifb\ of data at $\sqrt{s} =$ 13~TeV. Uncertainties in the background estimates due to systematic effects and %t.}
% \resizebox{1.3\textwidth}{!}{
%        \input{figures/2j/Yields_postFit.tex}
%        }
%\end{center} 
%\end{table} 
%\end{landscape}
