...
All leptons are required to be isolated, as defined though the standard \verb|PLVLoose| working point supported by combined performance groups. Leptons are additionally required to pass a non-prompt BDT selection described in detail in \cite{ttH_paper}. Optimized working points and scale factors for this BDT are taken from that analysis.
