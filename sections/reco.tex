...
Leptons are additionally required to pass a non-prompt BDT selection. This BDT and the WPs used are summarized in Appendix \ref{sec:lepMVA}, and described in detail in \cite{ttH_comb}. Optimized working points and scale factors for this BDT are taken from that analysis.
