...
\begin{figure}[h!]
\center
    \subfigure[]{\includegraphics[width=.29\linewidth]{tZ_bdt_ab127/1j/ab127/lep_Pt_0.pdf}}%
    \subfigure[]{\includegraphics[width=.29\linewidth]{tZ_bdt_ab127/1j/ab127/lep_Pt_1.pdf}}%
    \subfigure[]{\includegraphics[width=.29\linewidth]{tZ_bdt_ab127/1j/ab127/jet_Pt_0.pdf}}\\
    \subfigure[]{\includegraphics[width=.29\linewidth]{tZ_bdt_ab127/1j/ab127/topMassReco.pdf}}% 
    \subfigure[]{\includegraphics[width=.29\linewidth]{tZ_bdt_ab127/1j/ab127/Mll01.pdf}}%
    \subfigure[]{\includegraphics[width=.29\linewidth]{tZ_bdt_ab127/1j/ab127/Mll02.pdf}}\\
    \subfigure[]{\includegraphics[width=.29\linewidth]{tZ_bdt_ab127/1j/ab127/MET.pdf}}%                           
    \subfigure[]{\includegraphics[width=.29\linewidth]{tZ_bdt_ab127/1j/ab127/DRll01.pdf}}%                                  
    \subfigure[]{\includegraphics[width=.29\linewidth]{tZ_bdt_ab127/1j/ab127/minDeltaR_LJ_0.pdf}}\\                          
    %\subfigure[]{\includegraphics[width=.29\linewidth]{tZ_bdt_ab127/1j/ab127/DRll12.pdf}}\\
...
\begin{figure}[H]
\center
    \subfigure[]{\includegraphics[width=.45\linewidth]{tZ_bdt_ab127/1j/xgb_score.png}}%
    \subfigure[]{\includegraphics[width=.45\linewidth]{tZ_bdt_ab127/1j/roc.png}}    
