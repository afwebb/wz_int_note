...
%    \subfigure[]{\includegraphics[width=.47\linewidth]{tZInterference/lep3eta.eps}}\\
%    \subfigure[]{\includegraphics[width=.47\linewidth]{tZInterference/lepPairMass12.eps}}%
%    \subfigure[]{\includegraphics[width=.47\linewidth]{tZInterference/lepPairMass13.eps}}\\
%\end{figure}

%\begin{figure}[H]
%    \subfigure[]{\includegraphics[width=.47\linewidth]{tZInterference/drll12.eps}}%
%    \subfigure[]{\includegraphics[width=.47\linewidth]{tZInterference/drll13.eps}}\\                                      
%    \subfigure[]{\includegraphics[width=.47\linewidth]{tZInterference/btpt.eps}}% 
%    \subfigure[]{\includegraphics[width=.47\linewidth]{tZInterference/bteta.eps}}\\                                    
%\end{figure}
